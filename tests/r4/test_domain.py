...
def test_import_legacy_text_excludes_open_species_from_ratio_mapping():
    elements, ratios = import_legacy_element_ratio_text("Sb, Se, O, H", "2, 3")

    assert elements == ("Sb", "Se", "O", "H")
    assert ratios == {"Sb": 2.0, "Se": 3.0}
